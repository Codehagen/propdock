  ...
  return (
    <div className="bg-background">
      <div className="bg-card py-20 sm:py-40">
        <h1 className="mt-5 text-center font-display font-extrabold text-4xl text-foreground leading-[1.15] sm:text-6xl sm:leading-[1.15]">
          {post.title}
        </h1>
      </div>
      <MaxWidthWrapper className="flex max-w-screen-md flex-col items-center p-10 sm:pt-20">
        <MDX code={post.mdx} />
        <div className="mt-10 w-full border-border border-t pt-10 text-center">
