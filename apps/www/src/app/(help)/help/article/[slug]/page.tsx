        ...
        <MaxWidthWrapper className="grid max-w-screen-lg grid-cols-4 gap-10 py-10">
          <div className="col-span-4 flex flex-col space-y-8 sm:col-span-3 sm:pr-10">
            <div className="flex items-center space-x-2">
              <Link
                href="/help"
                className="whitespace-nowrap font-medium text-muted-foreground text-sm hover:text-foreground"
              >
                Alle kategorier
              </Link>
              ...
              <Link
                ...
                className="truncate font-medium text-muted-foreground text-sm hover:text-foreground"
              >
                {data.title}
              </Link>
            </div>
            <div className="flex flex-col space-y-4">
              <Link href={`/help/article/${data.slug}`}>
                <h1 className="!leading-snug font-bold font-display text-3xl text-foreground sm:text-4xl">
                  {data.title}
                </h1>
              </Link>
            ...
            {relatedArticles.length > 0 && (
              <div className="flex flex-col space-y-4 border-border border-t pt-8">
                <h2 className="font-bold font-display text-foreground text-xl sm:text-2xl">
                  Relaterte artikler
                </h2>
